Ext.onReady(function() {
	...
	// 1、创建head部分
		var head = new Ext.Panel( {
			region : 'north',
			border : false,
			html : '<div style="background:url('+contextPath+'/images/main1.gif) repeat-x; height:78px;"></div>',
			height : 80
		});
		...
		var mainTab = new Morik.Office.MainingPanel( {
			...
			items : [{
				title : '我的首页',
				html : '<div style="background:url('+contextPath+'/images/main.gif) no-repeat center middle; height:508px;"></div>'
			}]
		});
