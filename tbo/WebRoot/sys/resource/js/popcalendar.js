...
//	email :	fuushikaden@yahoo.com
	...
	var imgDir = baseDir			// directory for images ... e.g. var imgDir="/img/"

	//var gotoString = "转到当前月"
	//var todayString = "今天是 "
	//var weekString = "周"
	//var scrollLeftMessage = "滚动到上个月。"
	//var scrollRightMessage = "滚动到下个月。"
	//var selectMonthMessage = "选择月份。"
	//var selectYearMessage = "选择年。"
	//var selectDateMessage = "选择 [date] 作为填充日期." // do not replace [date], it will be replaced by date.
    ...
    */
	...
	function init1()	{
		if (!ns4)
		{
			...
			crossYearObj=(dom)?document.getElementById("selectYear1").style : ie? document.all.selectYear1 : document.selectYear1
			...
			if (showToday==1)
			{
				document.getElementById("lblToday").innerHTML =	todayString + " <a onmousemove='window.status=\""+gotoString+"\"' onmouseout='window.status=\"\"' title='"+gotoString+"' style='"+styleAnchor+"' href='javascript:monthSelected=monthNow;yearSelected=yearNow;constructCalendar();'>" +	monthName3[monthNow] + "-" + dateNow + "-" + yearNow + "</a>"
			}

			sHTML1="<span id='spanLeft'	style='border-style:solid;border-width:1;border-color:#3366FF;cursor:pointer' onmouseover='swapImage(\"changeLeft\",\"left2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+scrollLeftMessage+"\"' onclick='javascript:decMonth()' onmouseout='clearInterval(intervalID1);swapImage1(\"changeLeft\",\"left1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartDecMonth1()\",500)'	onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp<IMG id='changeLeft' SRC='"+imgDir+"left1.gif' width=10 height=11 BORDER=0>&nbsp</span>&nbsp;"
			sHTML1+="<span id='spanRight' style='border-style:solid;border-width:1;border-color:#3366FF;cursor:pointer'	onmouseover='swapImage(\"changeRight\",\"right2.gif\");this.style.borderColor=\"#88AAFF\";window.status=\""+scrollRightMessage+"\"' onmouseout='clearInterval(intervalID1);swapImage1(\"changeRight\",\"right1.gif\");this.style.borderColor=\"#3366FF\";window.status=\"\"' onclick='incMonth()' onmousedown='clearTimeout(timeoutID1);timeoutID1=setTimeout(\"StartIncMonth1()\",500)'	onmouseup='clearTimeout(timeoutID1);clearInterval(intervalID1)'>&nbsp<IMG id='changeRight' SRC='"+imgDir+"right1.gif'	width=10 height=11 BORDER=0>&nbsp</span>&nbsp"
	...
	function closeCalendar() {
		...
		//ctlToPlaceValue.value = padZero(monthSelected) + "/" + padZero(dateSelected) + "/" + yearSelected
		//alert(yearSelected);
	}
   ...
   function WeekNbr1(n) {
	...
	function constructCalendar () {
		...
		if (showWeekNumber==1)
		{
			sHTML += "<td align=left>" + WeekNbr1(startDate) + "&nbsp;</td>"
		}
